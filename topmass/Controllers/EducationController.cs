...
namespace topmass.Model
{
    ...
    public class EducationController : BaseController
    {
        ...
        public async Task<ActionResult> SaveEducations(List<InputEducationUserRequestAdd> requestAdd)
        {
            ...
            var allIdExited = await _profileBusiness.GetAllId(resultUser.UserId, 1);
            foreach (var item in requestAdd)
            {
                if (item.Id < 1)
                {
                ...
                else
                {
                    ...
                    await _profileBusiness.UpdateEducation(requestUpdate);
                }
            }
            ...
            {
                await _profileBusiness.DeleteEducation(new EducationUserInfoDeleteRequest()
                {
                    Id = item
                });
            }
