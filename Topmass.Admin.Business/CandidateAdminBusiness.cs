...
namespace Topmass.Admin.Business
{
    ...
    public class CandidateAdminBusiness : BaseBusiness, ICandidateAdminBusiness
    {
        ...
        public CandidateAdminBusiness(IAdminRepository _adminRepository,
            IRegionalBusiness regionalBusiness,
            IRecruitmentMailBussiness recruitmentMailBussiness,
            ICandidateAdminRepository candidateAdminRepository
        ...
        public async Task<SearchCandidateAdminReponse> GetAll(SearchCandidateAdminRequest request)
        {
            var reponse = new SearchCandidateAdminReponse();
            var data = await _candidateAdminRepository.GetAll(request);
