...
namespace crmHuman.Pages
{
    ...
    public class MetaDataListModel : BaseModel
    {
        ...
        public MetaDataListModel(ILogger<ArticleListModel> logger,
            IAdminArticleBusiness _business

            )
        {
            _logger = logger;
            TitlePage = "Danh sách Màn hình";
            KeyPage = "MetaDataList";
            TableColumnText = new List<string>()
            {
                "STT","Mã","Tiêu đề", "Mô tả ngắn",  "Hình ảnh",  "Từ khóa", "Cập nhật gần nhất","Thao tác"
            };
            NameController = "MetaDataList";
            business = _business;
